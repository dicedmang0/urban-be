...
const listUsername = [
  'Agus', 'Budi', 'Citra', 'Dewi', 'Eka', 'Fitri', 'Gita', 'Hendra', 'Indra', 'Joko', 
  'Kartika', 'Lestari', 'Maya', 'Nanda', 'Oki', 'Putra', 'Qory', 'Rina', 'Siti', 'Tono', 
  'Umar', 'Vina', 'Wahyu', 'Yuni', 'Zainal', 'Adi', 'Bintang', 'Cinta', 'Dewi', 'Eka', 
  'Fajar', 'Gita', 'Hadi', 'Indah', 'Jaya', 'Kiki', 'Laksmi', 'Maya', 'Nita', 'Oka', 
  'Putra', 'Rani', 'Sari', 'Tika', 'Ulis', 'Vina', 'Wira', 'Ikhsan', 'Yani', 'Zaki', 
  'Adit', 'Bima', 'Ciko', 'Dian', 'Eko', 'Fani', 'Gani', 'Hana', 'Ika', 'Jati', 
  'Kurnia', 'Lala', 'Mira', 'Nanda', 'Oni', 'Putri', 'Riko', 'Sita', 'Taufik', 'Udin', 
  'Vera', 'Wulan', 'Yuda', 'Zita', 'Alin', 'Budi', 'Citra', 'Dewa', 'Eni', 'Feri', 
  'Gisel', 'Hani', 'Irma', 'Juno', 'Kiki', 'Lia', 'Mila', 'Nanda', 'Oki', 'Putri', 
  'Rudi', 'Sinta', 'Tami', 'Uli', 'Vina', 'Widi', 'Yani', 'Zeni', 'Andi', 'Bima', 
  'Cinta', 'Dodi', 'Evi', 'Fitri', 'Gita', 'Hendra', 'Irwan', 'Jaya', 'Kurnia', 'Lila', 
  'Mita', 'Niko', 'Oka', 'Pala', 'Rian', 'Sari', 'Tini', 'Udin', 'Vero', 'Wina', 
  'Yudi', 'Zaki', 'Anisa', 'Bintang', 'Citra', 'Alam', 'Bagus', 'Damar', 'Elya', 
  'Farhan', 'Galih', 'Heru', 'Ismail', 'Joko', 'Kelana', 'Lintang', 'Mahesa', 'Nala', 
  'Omar', 'Prabowo', 'Raditya', 'Satria', 'Taufan', 'Utomo', 'Virga', 'Wisnu', 
  'Yudha', 'Zahra', 'Arif', 'Bayu', 'Candra', 'Dika', 'Elang', 'Fikri', 'Gilang', 
  'Hafiz', 'Irfan', 'Jamal', 'Kurniawan', 'Lukman', 'Meisa', 'Nabila', 'Pandu', 
  'Raka', 'Sandy', 'Tommy', 'Usman', 'Vian', 'Wira', 'Yuliana', 'Zuhri'
];

// Removing duplicates
const indonesianFirstNames = [...new Set(listUsername)];
const indonesianLastNames = [
  'Pratama', 'Wijaya', 'Saputra', 'Purnama', 'Nugroho', 'Santoso', 'Sutanto', 
  'Siregar', 'Manurung', 'Simanjuntak', 'Saragih', 'Nainggolan', 'Sitorus', 
  'Silalahi', 'Hutabarat', 'Pangaribuan', 'Hutapea', 'Ginting', 'Tarigan', 
  'Sembiring', 'Sinaga', 'Hutagalung', 'Marpaung', 'Sitompul', 'Tobing',
  'Sihombing', 'Harahap', 'Lubis', 'Pane', 'Rangkuti', 'Hutasoit', 'Pasaribu',
  'Sihotang', 'Simatupang', 'Purba', 'Batubara', 'Siagian', 'Samosir', 'Tambunan', 
  'Parlindungan', 'Simbolon', 'Sianturi', 'Simangunsong', 'Tanjung', 'Tambubolon', 
  'Sinurat', 'Hutasuhut', 'Hutajulu', 'Hutagaol', 'Sitorus', 'Saragih', 'Sibuea',
  'Sibarani', 'Sijabat', 'Purba', 'Silaen', 'Panjaitan', 'Butarbutar', 'Sianipar',
  'Sihombing', 'Situmorang', 'Rumapea', 'Simanungkalit', 'Sirait', 'Siallagan', 
  'Pakpahan', 'Purba', 'Lumban Gaol', 'Lumban Tobing', 'Pangihutan', 'Sihombing',
  'Girsang', 'Pangaribuan', 'Hutapea', 'Ginting', 'Tarigan', 'Sembiring', 'Sinaga',
  'Hutagalung', 'Marpaung', 'Sitompul', 'Tobing', 'Manik', 'Sianipar', 'Sarumpaet',
  'Hasibuan', 'Siagian', 'Lumbantoruan', 'Malau'
];
